...
const handleChangeSelectFile = () => {
  if(!file){
    AlertWarning("Adicione o arquivo") 
  }else{
    setValueParent(file)
  }
}
...
return (
  ...
  <button onClick={handleChangeSelectFile} className="px-5 py-2 bg-botao-padrao text-white rounded-md cursor-pointer absolute right-5 bottom-5 hover:bg-botao-padrao hover:opacity-50">AVANÇAR</button>
