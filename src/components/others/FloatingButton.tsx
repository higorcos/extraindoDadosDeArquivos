import SelectPortal from "../selectPortal/SelectPortal"
...
export default function FloatingButton(){
    ...
    const activeBox = (status:boolean)=>{
        setShowBox(status)
    }
    ...
    const { showPortal } = portalContext;
    ...
    <div className="fixed top-[5px] left-[5px] flex justify-center items-center flex-col z-[51] ">
        ...
        <a className="py-[20px] px-[20px] m-[5px] [box-shadow:rgba(149,_157,_165,_0.2)_0px_8px_24px] bg-[white] rounded-[15px]"
        href="#"
        title="Selecionar Orgão"
        onClick={()=>activeBox(true)}
        >
    ...
    {showBox && 
        <SelectPortal activeBox={activeBox}/>
    } 
    </>)
}